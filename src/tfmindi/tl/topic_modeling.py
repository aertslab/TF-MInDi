...
def run_topic_modeling(
    ...
    btm_max_biterms_per_region: int | None = 5000,
...
def select_topic_model(
    ...
    run_topic_modeling(
        ...
        btm_token_mode=params.get("btm_token_mode", "binary"),
        btm_max_biterms_per_region=params.get("btm_max_biterms_per_region", 1000),
        btm_max_tokens_per_region=params.get("btm_max_tokens_per_region", 200),
        btm_window_size=params.get("btm_window_size", None),
        store_key=store_key,
        verbose=bool(verbose),
        region_ids=None,
    )
