...
def select_topic_model(
    ...
    run_topic_modeling(
        ...
        btm_token_mode=str(params.get("btm_token_mode", "binary")),
        btm_max_biterms_per_region=int(params.get("btm_max_biterms_per_region", 1000)),
        btm_max_tokens_per_region=int(params.get("btm_max_tokens_per_region", 200)),
